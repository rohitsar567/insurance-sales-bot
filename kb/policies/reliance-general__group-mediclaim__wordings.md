---
policy_id: reliance-general__group-mediclaim__wordings
insurer_slug: reliance-general
insurer_name: reliance-general
policy_name: "IndusInd Group Mediclaim"
uin_code: RELHLGP21523V022021
---

# IndusInd Group Mediclaim

**Insurer:** reliance-general (`reliance-general`)  
**Policy ID:** `reliance-general__group-mediclaim__wordings`  
**UIN:** `RELHLGP21523V022021`
...
**Source:** `rag/corpus/reliance-general/group-mediclaim__wordings.pdf`
...
_Mirrored from `40-data/policy_facts/reliance-general__group-mediclaim__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
