---
policy_id: royal-sundaram__multiplier__brochure
insurer_slug: royal-sundaram
insurer_name: royal-sundaram
policy_name: "Multiplier Health Insurance Plan"
uin_code: RSAHLIP23030V012223
---

# Multiplier Health Insurance Plan

**Insurer:** royal-sundaram (`royal-sundaram`)  
**Policy ID:** `royal-sundaram__multiplier__brochure`  
**UIN:** `RSAHLIP23030V012223`

## Identity

### UIN code

**Value:** RSAHLIP23030V012223

**Source quote:**

> extracted from PDF policy document by NIM DeepSeek-V4 (D-019); see source PDF for verbatim

**Source:** `rag/corpus/royal-sundaram/multiplier__brochure.pdf`
...
_Mirrored from `40-data/policy_facts/royal-sundaram__multiplier__brochure.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
