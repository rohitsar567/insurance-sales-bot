---
policy_id: royal-sundaram__surrosafe__wordings
insurer_slug: royal-sundaram
insurer_name: royal-sundaram
policy_name: "Surrosafe Health Insurance"
uin_code: RSAHLIP24110V012324
---

# Surrosafe Health Insurance

**Insurer:** royal-sundaram (`royal-sundaram`)  
**Policy ID:** `royal-sundaram__surrosafe__wordings`  
**UIN:** `RSAHLIP24110V012324`

## Identity

### UIN code

**Value:** RSAHLIP24110V012324

**Source quote:**

> extracted from PDF policy document by NIM DeepSeek-V4 (D-019); see source PDF for verbatim

**Source:** `rag/corpus/royal-sundaram/surrosafe__wordings.pdf`
...
_Mirrored from `40-data/policy_facts/royal-sundaram__surrosafe__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
