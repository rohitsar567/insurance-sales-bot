---
policy_id: royal-sundaram__family-plus__wordings
...
**Policy ID:** `royal-sundaram__family-plus__wordings`  
...
**Source:** `rag/corpus/royal-sundaram/family-plus__wordings.pdf`
...
_Mirrored from `40-data/policy_facts/royal-sundaram__family-plus__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
