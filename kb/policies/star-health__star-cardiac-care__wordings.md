---
policy_id: star-health__star-cardiac-care__wordings
insurer_slug: star-health
insurer_name: Star Health and Allied Insurance
policy_name: "Star Cardiac Care Insurance Policy"
uin_code: SHAHLIP22032V022122
---

# Star Cardiac Care Insurance Policy

**Insurer:** Star Health and Allied Insurance (`star-health`)  
**Policy ID:** `star-health__star-cardiac-care__wordings`  
**UIN:** `SHAHLIP22032V022122`

## Identity

### UIN code

**Value:** SHAHLIP22032V022122
...
_Mirrored from `40-data/policy_facts/star-health__star-cardiac-care__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
