---
policy_id: acko__acko-health-iii__wordings
insurer_slug: acko
insurer_name: acko
policy_name: "Acko Health III"
...
**Insurer:** acko (`acko`)  
**Policy ID:** `acko__acko-health-iii__wordings`  
...
**Source:** `rag/corpus/acko/acko-health-iii__wordings.pdf`
...
_Mirrored from `data/policy_facts/acko__acko-health-iii__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
