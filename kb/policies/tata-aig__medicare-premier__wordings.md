...
**Value:** 5000000, 7500000, 10000000, 20000000, 30000000
...
_Mirrored from `data/policy_facts/tata-aig__medicare-premier__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
