...
**Policy ID:** `hdfc-ergo__total-health-plan__wordings`  
...
_Mirrored from `40-data/policy_facts/hdfc-ergo__total-health-plan__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
