---
policy_id: star-health__star-assure__wordings
insurer_slug: star-health
insurer_name: Star Health and Allied Insurance
policy_name: "Star Health Assure Insurance Policy"
...
**Policy ID:** `star-health__star-assure__wordings`  
...
**Value:** 500000, 1000000, 1500000, 2000000, 2500000, 5000000, 7500000, 10000000
...
_Mirrored from `40-data/policy_facts/star-health__star-assure__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
