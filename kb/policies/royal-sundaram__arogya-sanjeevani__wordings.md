---
policy_id: royal-sundaram__arogya-sanjeevani__wordings
insurer_slug: royal-sundaram
insurer_name: royal-sundaram
policy_name: "Arogya Sanjeevani Policy"
uin_code: RSAHLIP25013V022425
---

# Arogya Sanjeevani Policy

**Insurer:** royal-sundaram (`royal-sundaram`)  
**Policy ID:** `royal-sundaram__arogya-sanjeevani__wordings`  
**UIN:** `RSAHLIP25013V022425`

## Identity

### UIN code

**Value:** RSAHLIP25013V022425

**Source quote:**

> extracted from PDF policy document by NIM DeepSeek-V4 (D-019); see source PDF for verbatim

**Source:** `rag/corpus/royal-sundaram/arogya-sanjeevani__wordings.pdf`
...
_Mirrored from `data/policy_facts/royal-sundaram__arogya-sanjeevani__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
