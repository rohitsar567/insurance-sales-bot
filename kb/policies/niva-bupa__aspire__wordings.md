---
policy_id: niva-bupa__aspire__wordings
...
**Policy ID:** `niva-bupa__aspire__wordings`  
...
_Mirrored from `data/policy_facts/niva-bupa__aspire__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
