---
policy_id: royal-sundaram__presecure-advantage__wordings
insurer_slug: royal-sundaram
insurer_name: royal-sundaram
policy_name: "PreSecure Advantage"
uin_code: RSAHLIP25036V012425
---

# PreSecure Advantage

**Insurer:** royal-sundaram (`royal-sundaram`)  
**Policy ID:** `royal-sundaram__presecure-advantage__wordings`  
**UIN:** `RSAHLIP25036V012425`

## Identity

### UIN code

**Value:** RSAHLIP25036V012425

**Source quote:**

> extracted from PDF policy document by NIM DeepSeek-V4 (D-019); see source PDF for verbatim

**Source:** `rag/corpus/royal-sundaram/presecure-advantage__wordings.pdf`
...
_Mirrored from `40-data/policy_facts/royal-sundaram__presecure-advantage__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
