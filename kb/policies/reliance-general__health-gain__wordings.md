---
policy_id: reliance-general__health-gain__wordings
insurer_slug: reliance-general
insurer_name: reliance-general
policy_name: "IndusInd HealthGain Policy"
uin_code: INIHLIP26040V042526
---

# IndusInd HealthGain Policy

**Insurer:** reliance-general (`reliance-general`)  
**Policy ID:** `reliance-general__health-gain__wordings`  
**UIN:** `INIHLIP26040V042526`
...
**Source:** `rag/corpus/reliance-general/health-gain__wordings.pdf`
...
_Mirrored from `40-data/policy_facts/reliance-general__health-gain__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
