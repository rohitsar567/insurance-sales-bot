...
policy_name: "Optima Restore (with Stay Active)"
uin_code: HDHHLIP21322V062021
---

# Optima Restore (with Stay Active)

**Insurer:** HDFC ERGO General Insurance (`hdfc-ergo`)  
**Policy ID:** `hdfc-ergo__optima-restore__brochure`  
...
_Mirrored from `40-data/policy_facts/hdfc-ergo__optima-restore__brochure.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
