---
policy_id: sbi-general__super-health-insurance__wordings
insurer_slug: sbi-general
insurer_name: sbi-general
policy_name: "Super Health Insurance"
uin_code: SBIHLIP24141V022324
---

# Super Health Insurance

**Insurer:** sbi-general (`sbi-general`)  
**Policy ID:** `sbi-general__super-health-insurance__wordings`  
...
**Value:** SBIHLIP24141V022324

**Source quote:**

> extracted from PDF policy document by NIM DeepSeek-V4 (D-019); see source PDF for verbatim

**Source:** `rag/corpus/sbi-general/super-health-insurance__wordings.pdf`
...
_Mirrored from `40-data/policy_facts/sbi-general__super-health-insurance__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
