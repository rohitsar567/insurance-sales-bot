---
policy_id: niva-bupa__health-plus-top-up__wordings
insurer_slug: niva-bupa
insurer_name: Niva Bupa Health Insurance
policy_name: "Health+ (Super Top-Up)"
uin_code: NBHHLIP24135V012324
---

# Health+ (Super Top-Up)

**Insurer:** Niva Bupa Health Insurance (`niva-bupa`)  
**Policy ID:** `niva-bupa__health-plus-top-up__wordings`  
**UIN:** `NBHHLIP24135V012324`

## Identity

### UIN code

**Value:** NBHHLIP24135V012324

**Source quote:**

> extracted from PDF policy document by NIM DeepSeek-V4 (D-019); see source PDF for verbatim

**Source:** `rag/corpus/niva-bupa/health-plus-top-up__wordings.pdf`
...
_Mirrored from `data/policy_facts/niva-bupa__health-plus-top-up__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
