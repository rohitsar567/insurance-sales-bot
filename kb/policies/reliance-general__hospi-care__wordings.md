---
policy_id: reliance-general__hospi-care__wordings
insurer_slug: reliance-general
insurer_name: reliance-general
policy_name: "IndusInd Hospi Care Insurance"
uin_code: RELHLIP20027V012021
---

# IndusInd Hospi Care Insurance

**Insurer:** reliance-general (`reliance-general`)  
**Policy ID:** `reliance-general__hospi-care__wordings`  
**UIN:** `RELHLIP20027V012021`
...
**Source:** `rag/corpus/reliance-general/hospi-care__wordings.pdf`
...
_Mirrored from `data/policy_facts/reliance-general__hospi-care__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
