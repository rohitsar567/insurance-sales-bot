...
**Policy ID:** `icici-lombard__elevate__wordings`  
...
**Value:** 500000, 1000000, 1500000, 2000000, 2500000, 5000000, 10000000, 20000000, 30000000, 50000000, 100000000, 300000000
...
_Mirrored from `data/policy_facts/icici-lombard__elevate__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
