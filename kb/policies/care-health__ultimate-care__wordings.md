...
**Policy ID:** `care-health__ultimate-care__wordings`  
**UIN:** `CHIHLIP25044V012425`

## Identity

### UIN code

**Value:** CHIHLIP25044V012425

**Source quote:**

> extracted from PDF policy document by NIM DeepSeek-V4 (D-019); see source PDF for verbatim

**Source:** `rag/corpus/care-health/ultimate-care__wordings.pdf`
...
_Mirrored from `40-data/policy_facts/care-health__ultimate-care__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
