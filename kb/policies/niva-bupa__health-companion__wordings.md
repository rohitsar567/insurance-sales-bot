---
policy_id: niva-bupa__health-companion__wordings
...
**Policy ID:** `niva-bupa__health-companion__wordings`  
...
**Value:** 300000, 500000, 750000, 1000000, 1500000, 2500000, 5000000, 10000000
...
_Mirrored from `40-data/policy_facts/niva-bupa__health-companion__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
