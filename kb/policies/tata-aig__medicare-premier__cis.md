...
**Policy ID:** `tata-aig__medicare-premier__cis`  
...
**Source:** `rag/corpus/tata-aig/medicare-premier__cis.pdf`
...
_Mirrored from `40-data/policy_facts/tata-aig__medicare-premier__cis.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
