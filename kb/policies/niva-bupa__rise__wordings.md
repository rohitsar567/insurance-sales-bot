---
policy_id: niva-bupa__rise__wordings
...
**Policy ID:** `niva-bupa__rise__wordings`  
...
_Mirrored from `40-data/policy_facts/niva-bupa__rise__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
