---
policy_id: star-health__family-health-optima__wordings
...
**Policy ID:** `star-health__family-health-optima__wordings`  
...
**Value:** 300000, 500000, 1000000, 1500000, 2000000, 2500000
...
_Mirrored from `40-data/policy_facts/star-health__family-health-optima__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
