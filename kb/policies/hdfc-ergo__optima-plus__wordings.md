...
**Policy ID:** `hdfc-ergo__optima-plus__wordings`  
...
_Mirrored from `data/policy_facts/hdfc-ergo__optima-plus__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
