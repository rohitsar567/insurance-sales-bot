---
policy_id: manipalcigna__sarvah-param__wordings
...
**Policy ID:** `manipalcigna__sarvah-param__wordings`  
...
_Mirrored from `data/policy_facts/manipalcigna__sarvah-param__wordings.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
