---
policy_id: tata-aig__medicare-lite__cis
...
**Policy ID:** `tata-aig__medicare-lite__cis`  
...
_Mirrored from `data/policy_facts/tata-aig__medicare-lite__cis.json`. Provenance — every field's verbatim quote and source PDF path is preserved exactly as curated. Do not hand-edit; regenerate via `tools/build_kb_mirror.py`._
